...
public class GBlockModelRenderer {
    private final BlockColors blockColors;

    public GBlockModelRenderer(BlockColors blockColorsIn) {
...
//                int i = stateIn.getPackedLightmapCoords(worldIn, posIn.offset(enumfacing));
        ...
        List<BakedQuad> list1 = modelIn.getQuads(stateIn, null, 0);
    ...
    private void renderQuadsSmooth(IBlockAccess blockAccessIn, IBlockState stateIn, BlockPos posIn, BufferBuilder buffer, List<BakedQuad> list, float[] quadBounds, BitSet bitSet, GBlockModelRenderer.AmbientOcclusionFace aoFace) {
    ...
    public enum EnumNeighborInfo {
        DOWN(new EnumFacing[]{EnumFacing.WEST, EnumFacing.EAST, EnumFacing.NORTH, EnumFacing.SOUTH}, 0.5F, true, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.SOUTH, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.SOUTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.NORTH, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.NORTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.NORTH, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.NORTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.SOUTH, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.SOUTH}),
        UP(new EnumFacing[]{EnumFacing.EAST, EnumFacing.WEST, EnumFacing.NORTH, EnumFacing.SOUTH}, 1.0F, true, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.SOUTH, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.SOUTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.NORTH, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.NORTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.NORTH, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.NORTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.SOUTH, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.SOUTH}),
        NORTH(new EnumFacing[]{EnumFacing.UP, EnumFacing.DOWN, EnumFacing.EAST, EnumFacing.WEST}, 0.8F, true, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.FLIP_WEST}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.FLIP_EAST}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.FLIP_EAST}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.FLIP_WEST}),
        SOUTH(new EnumFacing[]{EnumFacing.WEST, EnumFacing.EAST, EnumFacing.DOWN, EnumFacing.UP}, 0.8F, true, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.WEST}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.FLIP_WEST, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.WEST, GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.WEST}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.EAST}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.FLIP_EAST, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.EAST, GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.EAST}),
        WEST(new EnumFacing[]{EnumFacing.UP, EnumFacing.DOWN, EnumFacing.NORTH, EnumFacing.SOUTH}, 0.6F, true, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.SOUTH, GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.SOUTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.NORTH, GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.NORTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.NORTH, GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.NORTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.SOUTH, GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.SOUTH}),
        EAST(new EnumFacing[]{EnumFacing.DOWN, EnumFacing.UP, EnumFacing.NORTH, EnumFacing.SOUTH}, 0.6F, true, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.SOUTH, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.SOUTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.NORTH, GBlockModelRenderer.Orientation.FLIP_DOWN, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.DOWN, GBlockModelRenderer.Orientation.NORTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.NORTH, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.FLIP_NORTH, GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.NORTH}, new GBlockModelRenderer.Orientation[]{GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.SOUTH, GBlockModelRenderer.Orientation.FLIP_UP, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.FLIP_SOUTH, GBlockModelRenderer.Orientation.UP, GBlockModelRenderer.Orientation.SOUTH});

        private static final GBlockModelRenderer.EnumNeighborInfo[] VALUES = new GBlockModelRenderer.EnumNeighborInfo[6];
        ...
        private final GBlockModelRenderer.Orientation[] vert0Weights;
        private final GBlockModelRenderer.Orientation[] vert1Weights;
        private final GBlockModelRenderer.Orientation[] vert2Weights;
        private final GBlockModelRenderer.Orientation[] vert3Weights;

        EnumNeighborInfo(EnumFacing[] p_i46236_3_, float p_i46236_4_, boolean p_i46236_5_, GBlockModelRenderer.Orientation[] p_i46236_6_, GBlockModelRenderer.Orientation[] p_i46236_7_, GBlockModelRenderer.Orientation[] p_i46236_8_, GBlockModelRenderer.Orientation[] p_i46236_9_) {
        ...
        public static GBlockModelRenderer.EnumNeighborInfo getNeighbourInfo(EnumFacing p_178273_0_) {
    ...
    enum VertexTranslations {
        ...
        private static final GBlockModelRenderer.VertexTranslations[] VALUES = new GBlockModelRenderer.VertexTranslations[6];
        ...
        public static GBlockModelRenderer.VertexTranslations getVertexTranslations(EnumFacing p_178184_0_) {
    ...
    class AmbientOcclusionFace {
        ...
        public void updateVertexBrightness(IBlockAccess worldIn, IBlockState state, BlockPos centerPos, EnumFacing direction, float[] faceShape, BitSet shapeState) {
            ...
            GBlockModelRenderer.EnumNeighborInfo blockmodelrenderer$enumneighborinfo = GBlockModelRenderer.EnumNeighborInfo.getNeighbourInfo(direction);
            ...
            GBlockModelRenderer.VertexTranslations blockmodelrenderer$vertextranslations = GBlockModelRenderer.VertexTranslations.getVertexTranslations(direction);
