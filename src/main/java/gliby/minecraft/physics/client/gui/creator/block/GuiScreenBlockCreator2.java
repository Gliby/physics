...
public class GuiScreenBlockCreator2 extends GuiScreenCreator {
    ...
    public void initGui() {
        ...
        this.blockList = new GuiSlotBlockList(this, mc, 100, 0, 32, height - 85, 140, fontRenderer.FONT_HEIGHT);
    ...
    protected void mouseClicked(int x, int y, int button) throws IOException {
        ...
        if (!editing) {
            ...
            if (button == 1 && x >= modSearch.x && x < modSearch.y + modSearch.width
                    && y >= modSearch.y && y < modSearch.y + modSearch.height) {
                modSearch.setText("");
            }
        } else {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick) {
        ...
        this.modList.drawScreen(mouseX, mouseY);
    ...
    public class BlockIdentifier {
        ...
        public BlockIdentifier(ResourceLocation id, Block block) {
            super();
            this.id = id;
            this.block = block;
        }
