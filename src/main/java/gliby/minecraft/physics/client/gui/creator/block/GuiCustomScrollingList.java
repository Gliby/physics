...
public abstract class GuiCustomScrollingList {
    ...
    public void drawScreen(int mouseX, int mouseY, float p_22243_3_) {
        ...
        if (this.client.theWorld != null) {
            ...
            worldr.addVertexWithUV(this.left, this.bottom, 0.0D, (float) this.left / var17,
                    (float) (this.bottom + (int) this.scrollDistance) / var17);
            worldr.addVertexWithUV(this.right, this.bottom, 0.0D,
                    (float) this.right / var17,
                    (float) (this.bottom + (int) this.scrollDistance) / var17);
            worldr.addVertexWithUV(this.right, this.top, 0.0D, (float) this.right / var17,
                    (float) (this.top + (int) this.scrollDistance) / var17);
            worldr.addVertexWithUV(this.left, this.top, 0.0D, (float) this.left / var17,
                    (float) (this.top + (int) this.scrollDistance) / var17);
            tess.draw();
        }
        ...
        for (var11 = 0; var11 < listLength; ++var11) {
            ...
            if (var19 <= this.bottom && var19 + var13 >= this.top) {
                if (this.field_25123_p && this.isSelected(var11)) {
                    ...
                    worldr.addVertexWithUV(var14, var19 + var13 + 2, 0.0D, 0.0D, 1.0D);
                    worldr.addVertexWithUV(var15, var19 + var13 + 2, 0.0D, 1.0D, 1.0D);
                    worldr.addVertexWithUV(var15, var19 - 2, 0.0D, 1.0D, 0.0D);
                    worldr.addVertexWithUV(var14, var19 - 2, 0.0D, 0.0D, 0.0D);
                    worldr.setColorOpaque_I(0);
                    worldr.addVertexWithUV(var14 + 1, var19 + var13 + 1, 0.0D, 0.0D, 1.0D);
                    worldr.addVertexWithUV(var15 - 1, var19 + var13 + 1, 0.0D, 1.0D, 1.0D);
                    worldr.addVertexWithUV(var15 - 1, var19 - 1, 0.0D, 1.0D, 0.0D);
                    worldr.addVertexWithUV(var14 + 1, var19 - 1, 0.0D, 0.0D, 0.0D);
                    tess.draw();
        ...
        worldr.addVertexWithUV(this.left, this.top + var20, 0.0D, 0.0D, 1.0D);
        worldr.addVertexWithUV(this.right, this.top + var20, 0.0D, 1.0D, 1.0D);
        ...
        worldr.setColorRGBA_I(0, 0);
        worldr.addVertexWithUV(this.right, this.bottom - var20, 0.0D, 1.0D, 0.0D);
        worldr.addVertexWithUV(this.left, this.bottom - var20, 0.0D, 0.0D, 0.0D);
        tess.draw();
        var19 = this.getContentHeight() - (this.bottom - this.top - 4);
        ...
        if (var19 > 0) {
            ...
            worldr.startDrawingQuads();
            worldr.setColorRGBA_I(0, 255);
            worldr.addVertexWithUV(scrollBarXStart, this.bottom, 0.0D, 0.0D, 1.0D);
            worldr.addVertexWithUV(scrollBarXEnd, this.bottom, 0.0D, 1.0D, 1.0D);
            worldr.addVertexWithUV(scrollBarXEnd, this.top, 0.0D, 1.0D, 0.0D);
            worldr.addVertexWithUV(scrollBarXStart, this.top, 0.0D, 0.0D, 0.0D);
            tess.draw();
            worldr.startDrawingQuads();
            worldr.setColorRGBA_I(8421504, 255);
            worldr.addVertexWithUV(scrollBarXStart, var14 + var13, 0.0D, 0.0D, 1.0D);
            worldr.addVertexWithUV(scrollBarXEnd, var14 + var13, 0.0D, 1.0D, 1.0D);
            worldr.addVertexWithUV(scrollBarXEnd, var14, 0.0D, 1.0D, 0.0D);
            worldr.addVertexWithUV(scrollBarXStart, var14, 0.0D, 0.0D, 0.0D);
            tess.draw();
            worldr.startDrawingQuads();
            worldr.setColorRGBA_I(12632256, 255);
            worldr.addVertexWithUV(scrollBarXStart, var14 + var13 - 1, 0.0D, 0.0D, 1.0D);
            worldr.addVertexWithUV(scrollBarXEnd - 1, var14 + var13 - 1, 0.0D, 1.0D, 1.0D);
            worldr.addVertexWithUV(scrollBarXEnd - 1, var14, 0.0D, 1.0D, 0.0D);
            worldr.addVertexWithUV(scrollBarXStart, var14, 0.0D, 0.0D, 0.0D);
            tess.draw();
        }
