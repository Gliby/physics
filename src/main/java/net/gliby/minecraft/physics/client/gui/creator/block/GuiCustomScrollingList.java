...
public abstract class GuiCustomScrollingList {
	...
	public void drawScreen(int mouseX, int mouseY, float p_22243_3_) {
		...
		if (this.client.theWorld != null) {
			...
			worldr.addVertexWithUV((double) this.left, (double) this.bottom, 0.0D, (double) ((float) this.left / var17),
			...
			worldr.addVertexWithUV((double) this.right, (double) this.bottom, 0.0D,
					...
					(double) ((float) (this.bottom + (int) this.scrollDistance) / var17));
			worldr.addVertexWithUV((double) this.right, (double) this.top, 0.0D, (double) ((float) this.right / var17),
					(double) ((float) (this.top + (int) this.scrollDistance) / var17));
			worldr.addVertexWithUV((double) this.left, (double) this.top, 0.0D, (double) ((float) this.left / var17),
					(double) ((float) (this.top + (int) this.scrollDistance) / var17));
			tess.draw();
		}
	...
	private void overlayBackground(int p_22239_1_, int p_22239_2_, int p_22239_3_, int p_22239_4_) {
		...
		worldr.addVertexWithUV((double) this.listWidth + 30, (double) p_22239_2_, 0.0D,
				(double) ((float) (this.listWidth + 30) / var6), (double) ((float) p_22239_2_ / var6));
		worldr.setColorRGBA_I(4210752, p_22239_3_);
		worldr.addVertexWithUV((double) this.listWidth + 30, (double) p_22239_1_, 0.0D,
				(double) ((float) (this.listWidth + 30) / var6), (double) ((float) p_22239_1_ / var6));
