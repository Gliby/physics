 ...
 */
package net.gliby.minecraft.physics.client.render;

import java.util.HashMap;
import java.util.Map;

import net.gliby.minecraft.gman.client.render.ItemRendererManager;
import net.gliby.minecraft.physics.Physics;
import net.gliby.minecraft.physics.client.render.entity.RenderPhysicsBlock;
import net.gliby.minecraft.physics.client.render.entity.RenderPhysicsModelPart;
import net.gliby.minecraft.physics.client.render.entity.RenderToolGunBeam;
import net.gliby.minecraft.physics.client.render.items.RenderItemPhysicsGun;
import net.gliby.minecraft.physics.client.render.items.RenderItemToolGun;
import net.gliby.minecraft.physics.client.render.lighting.DummyLight;
import net.gliby.minecraft.physics.client.render.lighting.IDynamicLightHandler;
import net.gliby.minecraft.physics.client.render.player.RenderAdditionalPlayer;
import net.gliby.minecraft.physics.client.render.world.RenderAdditionalWorld;
import net.gliby.minecraft.physics.common.entity.EntityPhysicsBlock;
import net.gliby.minecraft.physics.common.entity.EntityPhysicsModelPart;
import net.gliby.minecraft.physics.common.entity.EntityToolGunBeam;
