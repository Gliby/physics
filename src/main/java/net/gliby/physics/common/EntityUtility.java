...
public class EntityUtility {
	...
	public static Vector3f getPositionEyes(Entity base) {
		return new Vector3f((float) base.posX, (float) base.posY + (float) base.getEyeHeight(), (float) base.posZ);
	}
	...
	private static Vec3 getPositionEyesMC(Entity base) {
		return new Vec3(base.posX, base.posY + (double) base.getEyeHeight(), base.posZ);
	}
}
