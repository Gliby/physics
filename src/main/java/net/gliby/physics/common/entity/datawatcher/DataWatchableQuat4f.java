 ...
 */
package net.gliby.physics.common.entity.datawatcher;
...
public class DataWatchableQuat4f extends DataWatchableObject {
	...
	public void read(Object... obj) {
		...
		quat.set(rotation.getX(), rotation.getY(), rotation.getZ(), entity.getDataWatcher().getWatchableObjectFloat(indexW));
	}
