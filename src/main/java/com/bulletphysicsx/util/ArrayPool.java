...
package com.bulletphysicsx.util;
...
public class ArrayPool<T> {
    ...
    private static Comparator floatComparator = new Comparator() {
        public int compare(Object o1, Object o2) {
            if (o1 == null || o2 == null) return o1 != null ? 1 : 0;
    ...
    /**
     * Returns per-thread array pool for given type, or create one if it doesn't
     * exist.
     *
     * @param cls type
     * @return object pool
    ...
    /**
     * Returns array of exactly the same length as demanded, or create one if
    ...
    /**
     * Returns array that has same or greater length, or create one if not
     * present in the pool.
     *
