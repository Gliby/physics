...
import static com.bulletphysicsx.collision.broadphase.BroadphaseNativeType.SPHERE_SHAPE_PROXYTYPE;
import static com.bulletphysicsx.collision.broadphase.BroadphaseNativeType.STATIC_PLANE_PROXYTYPE;

import com.bulletphysicsx.collision.broadphase.BroadphaseNativeType;
import com.bulletphysicsx.collision.narrowphase.ConvexPenetrationDepthSolver;
import com.bulletphysicsx.collision.narrowphase.GjkEpaPenetrationDepthSolver;
...
public class DefaultCollisionConfiguration extends CollisionConfiguration {
    ...
    public DefaultCollisionConfiguration() {
        ...
        //default CreationFunctions, filling the m_doubleDispatch table
		*/
        voxelCF = new JBulletVoxelWorldCollisionAlgorithm.CreateFunc();
        swappedVoxelCF = new JBulletVoxelWorldCollisionAlgorithm.SwappedCreateFunc();
